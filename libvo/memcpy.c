 ...
 * Local prototypes.
 *****************************************************************************/
void * ALTIVEC_memcpy ( void * to, const void * from, size_t len );


#define CAN_COMPILE_C_ALTIVEC
#define __BUILD_ALTIVEC_ASM__
...
void * ALTIVEC_memcpy( void * _to, const void * _from, size_t len )
{
    void * retval = _to;
